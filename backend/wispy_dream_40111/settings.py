"""
Django settings for wispy_dream_40111 project.
...
ROOT_URLCONF = 'wispy_dream_40111.urls'
...
WSGI_APPLICATION = 'wispy_dream_40111.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "wispy_dream_40111 API",
    "DESCRIPTION": "API documentation for wispy_dream_40111 App",
    "VERSION": "v1",
}
